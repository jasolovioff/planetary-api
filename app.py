...
def add_planet():
    ...
    if test:
        ...
        new_planet = Planet(planet_name=planet_name, planet_type=planet_type, mass=mass, radius=radius, distance=distance, home_star=home_star)
...
@jwt_required
def remove_planet(planet_id: id):
    planet = Planet.query.filter_by(planet_id=planet_id).first()
    if planet:
